...
# Geocode cache path is set dynamically via self.cache_dir (from DataSource base class)
...
class DPRSource(DataSource):
    ...
    @property
    def url(self) -> str:
        return "https://data.cityofnewyork.us/Recreation/Directory-of-Eateries/8792-ebcp"
    ...
    def fetch(self) -> list[Venue]:
        ...
        # Load geocode cache
        geocode_cache = self.cache_dir / "dpr_geocode.json"
        cache: dict[str, Any] = {}
